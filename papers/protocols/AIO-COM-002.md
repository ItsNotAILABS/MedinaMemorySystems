...
This protocol defines the trust handshake lifecycle for AI sessions, including mutual attestation exchange, session authorization, and controlled closure.
