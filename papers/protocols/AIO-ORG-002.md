...
This protocol defines how AI organisms declare, verify, and negotiate capabilities so workflow routing can match tasks to organisms with proven competence.
