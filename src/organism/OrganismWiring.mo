    ...
    func createPackageSubstrateWire() : PackageSubstrateWire {
        {
            ...
            packageWires = [
                ...
                { packageId = "PKG-005"; packageName = "@medina/harmonic-computation-engine"; terminal = "/formula"; moduleCount = 6; exportCount = 25; engineBinding = "ENGINE-011-GEOMETRY"; frequency = Constants.PHI; phiCoefficient = Constants.PHI_SQUARED; isAbsorbed = true },
                ...
                { packageId = "PKG-008"; packageName = "@medina/civilization-pattern-engine"; terminal = "/prim"; moduleCount = 24; exportCount = 10; engineBinding = "ENGINE-005-QUANTUM"; frequency = 7.83; phiCoefficient = Constants.PHI; isAbsorbed = true },
